package cy.review.imageloaderapp;
...
import cy.review.imageloaderapp.loader.ImageLoader;
import cy.review.imageloaderapp.utils.MyUtils;
...
//                "https://10.0.2.2:8080/p1.jpg",
//                "https://10.0.2.2:8080/p2.jpg",
//                "https://10.0.2.2:8080/p3.jpg",
//                "https://10.0.2.2:8080/p4.jpg",
//                "https://10.0.2.2:8080/p5.jpg",
//                "https://10.0.2.2:8080/p6.jpg",
//                "https://10.0.2.2:8080/p7.jpg",
//                "https://10.0.2.2:8080/p8.jpg",
//                "https://10.0.2.2:8080/p9.jpg",
//                "https://10.0.2.2:8080/p10.jpg",
//                "https://10.0.2.2:8080/p1.jpg",
//                "https://10.0.2.2:8080/p2.jpg",
//                "https://10.0.2.2:8080/p3.jpg",
//                "https://10.0.2.2:8080/p4.jpg",
...
//                "https://10.0.2.2:8080/p10.jpg",
    ...
    private class ImageAdapter extends BaseAdapter {
        ...
        private ImageAdapter(Context context) {
            ...
            mDefaultBitmapDrawable = context.getResources().getDrawable(R.drawable.ic_launcher_foreground);
        }
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            //仅当列表停止时才能加载图片，这是一种列表卡顿的优化方式，
            // 避免频繁上下滑动造成的大量异步任务频繁在主线程中更新UI
            if (mIsGridViewIdle && mCanGetBitmapFromNetWork) {
                imageView.setTag(uri);
                mImageLoader.bindBitmap(uri, imageView, mImageWidth, mImageWidth);//将复杂的图片加载过程交给ImageLoader
            }
            return convertView;
        }
